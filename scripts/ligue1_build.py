...
Targets the 2026-27 season; override with LIGUE1_START / LIGUE1_END (YYYYMMDD)
...
CONFIG = dict(
    slug="fra.1",
    start=os.environ.get("LIGUE1_START", "20260701"),
    end=os.environ.get("LIGUE1_END", "20270630"),
    out_name="ligue1",
    tm_limit=int(os.environ.get("LIGUE1_TM_LIMIT") or "26"),
)
